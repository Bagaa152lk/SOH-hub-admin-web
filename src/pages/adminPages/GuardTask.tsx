...
export default function GuardTaskPage() {
  ...
  const employee = selectedGuards[0];

  function addTaskGuard() {
    setAddTask(true);
    setSelectedReport(null);
  }
  const filteredGuards =
    listUsersData?.listUsers?.filter((user: any) =>
        ...
        <div className="w-full h-[56px] custom-background flex justify-between items-center px-[20px] py-[16px]">
          <div className="flex items-center gap-[6px]">
            ...
            <div className="px-[10px] py-[8px] h-[28px] flex justify-center items-center rounded-[18px] bg-[rgba(255,255,255,0.08)] text-[12px] text-white">
              {data?.getRequests && data?.getRequests?.length}
            </div>
          </div>
                ...
                >
                  <div className="flex gap-[10px] items-center">
                    ...
                    <div className="flex items-center gap-[8px]">
                      <img
                        src={
                          feedback?.toUserId?.profilePic ?? "/image/profile.png"
                        }
                  ...
                  <span className="ml-[20px] w-[111px]  overflow-hidden whitespace-nowrap text-ellipsis border border-white/15 bg-white/10 rounded-[8px] px-[14px] py-[8px] ">
                    {feedback.title}
                  </span>
                  <span className=" w-[500px] ml-[50px] overflow-hidden whitespace-nowrap text-ellipsis">
                    {feedback.desc}
                  </span>
