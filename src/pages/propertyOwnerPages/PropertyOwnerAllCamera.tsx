...
export default function PropertyAllCamera() {
  ...
  const sendDataToFullCamera = (cameraData: any) => {
    navigate(`/home-owner/:id/camera-table/${cameraData.id}`);
  };
  return (
    <div className="w-full flex flex-wrap gap-[20px]">
      <div className="w-[1436px] h-[942px]">
        <div className="rounded-[18px] w-full h-full bg-black/10 overflow-hidden">
          <div className="w-full px-[18px] py-[19px] flex items-center justify-between custom-background">
